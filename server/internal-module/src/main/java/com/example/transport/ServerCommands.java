...
public enum ServerCommands {
    ...
    GET_GAME_INFO {
        ...
        public GameInstance send(String params, PlayerData player, Integer gameID) throws Exception {
    ...
    GET_ALL_PLAYERS_DATA {
        ...
        public GameInstance send(String params, PlayerData player, Integer gameID) throws Exception {
            Map<Integer, PlayerData> players = ServerCommands.getGameSession().getAllPlayersData();
            if (players == null) {
    ...
    public abstract GameInstance send(String var1, PlayerData var2, Integer var3) throws Exception;
