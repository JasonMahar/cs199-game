...
public class GameSession implements GameSessionInterface {
    ...
    public GameInstance getGameData(Integer gameID) throws Exception {
    ...
    public Map<Integer, PlayerData> getAllPlayersData() {

        Map<Integer, PlayerData> playersMap = new HashMap<>();
    ...
    private static GameInstance createGameInstanceFromJSON(JSONObject json) throws Exception {
        ...
        Map<Integer, PlayerData> playersHashMap = new HashMap<>();
        ...
        PrintUtils.cyan("create game instance from json");
